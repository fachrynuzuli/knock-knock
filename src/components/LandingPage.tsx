...
const LandingPage: React.FC<LandingPageProps> = ({ onEnterGameFlow }) => {
  ...
  // Video section parallax with enhanced smoothness - REMOVED SCALE
  ...
  // Final CTA - dramatic entrance with spring physics - REMOVED SCALE
  ...
  return (
    <div className="min-h-screen bg-gray-900 relative overflow-x-hidden smooth-scroll-container">
      ...
      <div className="relative z-20 flex flex-col scroll-snap-container">
        ...
        {/* Walkthrough Video Section with enhanced smoothness - REMOVED SCALE */}
        <motion.section 
        ...
        {/* Final CTA Section with dramatic enhanced parallax - REMOVED SCALE */}
        <motion.section 
          className="py-16 px-4 parallax-section scroll-snap-section"
          style={{ y: finalCtaY }}
        >
